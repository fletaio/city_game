...
func init() {
	data.RegisterEvent("fletacity.Construction", func(t event.Type) event.Event {
...
// ConstructionEvent is a event of adding count to the account
...
func (e *ConstructionEvent) WriteTo(w io.Writer) (int64, error) {
	var wrote int64
...
func (e *ConstructionEvent) ReadFrom(r io.Reader) (int64, error) {
	var read int64
...
func (e *ConstructionEvent) MarshalJSON() ([]byte, error) {
