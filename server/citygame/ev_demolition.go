...
func init() {
	data.RegisterEvent("fletacity.Demolition", func(t event.Type) event.Event {
		return &DemolitionEvent{
			Base: event.Base{
				Type_: t,
			},
		}
...
// DemolitionEvent is a event of adding count to the account
...
func (e *DemolitionEvent) WriteTo(w io.Writer) (int64, error) {
	var wrote int64
...
func (e *DemolitionEvent) ReadFrom(r io.Reader) (int64, error) {
	var read int64
...
func (e *DemolitionEvent) MarshalJSON() ([]byte, error) {
